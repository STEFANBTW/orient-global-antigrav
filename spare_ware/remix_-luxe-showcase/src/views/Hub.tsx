...
export default function Hub({ navigateTo, onProductClick }: { navigateTo: (view: string) => void, onProductClick?: (product: unknown) => void }) {
  return (
              ...
              <div className="min-w-[320px] md:min-w-[380px] snap-start bg-white rounded-3xl overflow-hidden flex flex-col group">
                ...
                <div className="p-8 flex flex-col flex-1">
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <button className="h-12 w-12 rounded-xl bg-slate-900 text-white flex items-center justify-center hover:bg-primary transition-colors">
