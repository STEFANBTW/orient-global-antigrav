...
export default function WomensFashion({ navigateTo }: { navigateTo: (view: string) => void }) {
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-12">
              ...
              <nav className="hidden md:flex items-center gap-8">
                <a className="text-sm font-semibold hover:text-orange-500 transition-colors" href="#">New</a>
                <a className="text-sm font-semibold text-orange-500 border-b-2 border-orange-500" href="#">Clothing</a>
                <a className="text-sm font-semibold hover:text-orange-500 transition-colors" href="#">Accessories</a>
                <a className="text-sm font-semibold hover:text-orange-500 transition-colors text-red-500" href="#">Sale</a>
              </nav>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <button onClick={() => navigateTo("fashion")} className="flex items-center gap-2 text-sm font-bold text-slate-500 hover:text-orange-500 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            <div className="group cursor-pointer">
                ...
                <div className="mt-4 flex justify-between">
                    ...
                    <span className="font-bold text-orange-500">$280</span>
                </div>
            </div>
        </div>
      </main>
