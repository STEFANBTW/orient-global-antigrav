...
const Hardware: React.FC = () => {
    ...
    const hardwareBlock = cmsData?.blocks?.find((b: any) => b.block_type === 'hardware')?.content_payload || {
        ...
        rigs: {
            title: "The Rigs",
            subtitle: "Custom \"Titan\" Build",
            desc: "Engineered for zero-compromise performance. Our custom loop cooling system ensures peak clock speeds are maintained indefinitely, even during 8K rendering loads.",
        }
    };
            ...
            <section className="relative min-h-screen flex flex-col justify-center items-center px-4 pt-20 border-b border-white/10" id="hero">
                ...
                <div className="w-full max-w-[1920px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center z-10">
                    <div className="lg:col-span-8">
                        ...
                        >
                            {hardwareBlock.hero.title1}<br />
                            {hardwareBlock.hero.title2}<br />
                            <span className="text-transparent stroke-text" style={{ WebkitTextStroke: '2px #0df2f2' }}>{hardwareBlock.hero.titleHighlight}</span>
                        </motion.h1>
                        <div className="flex flex-wrap gap-8 text-sm text-gray-400 font-mono mt-8 border-t border-white/10 pt-8 max-w-2xl bg-[#111] p-6" style={{ clipPath: 'polygon(20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)' }}>
                            <div className="flex flex-col">
                                ...
                                <span className="text-[#0df2f2] text-2xl font-bold">{hardwareBlock.hero.renderScale}</span>
                            </div>
                            <div className="flex flex-col border-l border-white/10 pl-8">
                                <span className="text-[10px] text-gray-500 mb-1 uppercase tracking-widest">Frame Rate</span>
                                <span className="text-[#0df2f2] text-2xl font-bold">{hardwareBlock.hero.frameRate}</span>
                            </div>
                            <div className="flex flex-col border-l border-white/10 pl-8">
                                <span className="text-[10px] text-gray-500 mb-1 uppercase tracking-widest">Input Lag</span>
                                <span className="text-[#0df2f2] text-2xl font-bold">{hardwareBlock.hero.inputLag}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-[1920px] mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-20">
                        <div>
                            ...
                            <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter">{hardwareBlock.rigs.title}</h2>
                        </div>
                    ...
                    <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="space-y-8">
                            <div className="border-l-2 border-[#0df2f2] pl-6 py-2 bg-gradient-to-r from-[#0df2f2]/10 to-transparent">
                                <h3 className="text-3xl font-black text-white mb-2 uppercase tracking-tight">{hardwareBlock.rigs.subtitle}</h3>
