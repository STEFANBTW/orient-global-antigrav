...
const Menu: React.FC = () => {
  ...
  const drinksMenu = cmsData?.blocks?.find((b: any) => b.block_type === 'drinks_menu')?.content_payload || {
    signature: [
      {
    ...
    roastedMeats: [
      {
        name: 'Suya Spiced Lamb Chops', price: '₦45,000',
      ...
      {
        name: 'Smoked Duck Breast', price: '₦32,000',
      ...
      {
        name: 'Roasted Bone Marrow', price: '₦24,000',
      ...
      {
        name: 'Charred Octopus', price: '₦28,000',
      ...
      {
        name: 'Slow-Roasted Goat Leg', price: '₦38,000',
      ...
      {
        name: 'Tomahawk Steak', price: '₦120,000',
    ...
    <div className="bg-[#050505] font-newsreader text-white min-h-screen selection:bg-primary-gold selection:text-black">
      ...
      <section className="py-24 px-6 max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {drinksMenu.signature.map((item: any, i: number) => (
      ...
      <section className="py-32 bg-[#080808] relative">
        <div className="max-w-[1400px] mx-auto px-6 relative z-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {drinksMenu.roastedMeats.map((dish: any, i: number) => (
      ...
      <section className="py-32 px-6 max-w-[1400px] mx-auto border-b border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {drinksMenu.rareSpirits.map((spirit: any, i: number) => (
      ...
      <section className="py-32 px-6 max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {drinksMenu.wineVault.map((wine: any, i: number) => (
            <div key={i} className="group cursor-pointer">
              <div className="aspect-[3/4] overflow-hidden rounded-sm mb-6 relative">
