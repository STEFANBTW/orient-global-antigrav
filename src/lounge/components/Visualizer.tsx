...
const Visualizer: React.FC<{ onNavigate?: (p: any) => void }> = ({ onNavigate }) => {
  ...
  const heroBlock = cmsData?.blocks?.find((b: any) => b.block_type === 'hero')?.content_payload || {
    title1: "UNWIND",
    title2: "IN NOIR",
    subtitle: "Where shadows meet the golden hour. Experience the enigma of the Orient.",
    bgImage: "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&q=80&w=2000"
  };
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <h1 className="font-newsreader italic text-7xl md:text-[120px] lg:text-[140px] text-white leading-[0.85] mb-8 drop-shadow-2xl">
            {heroBlock.title1} <br /> <span className="not-italic font-light tracking-tight">{heroBlock.title2}</span>
          </h1>
