...
const Logistics: React.FC = () => {
   ...
   const logisticsBlock = cmsData?.blocks?.find((b: any) => b.block_type === 'logistics')?.content_payload || {};
   ...
   const chapters = logisticsBlock.chapters || [
   ...
   const bulkProducts = logisticsBlock.catalog || [
      {
      ...
      <div className="bg-slate-950 min-h-screen text-slate-100 font-sans selection:bg-primary selection:text-slate-900">
         ...
         <section className="py-32 bg-slate-900 border-t border-slate-800 relative z-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
               ...
               {/* Products Grid */}
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {bulkProducts.map((item: any, i: number) => (
