      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="space-y-4 max-w-md">
           <div className="flex justify-between items-center border-b pb-4">
              ...
              <div className="w-10 h-6 bg-[var(--color-accent-light)] rounded-full relative cursor-pointer"><div className="w-4 h-4 bg-white rounded-full absolute right-1 top-1"></div></div>
           </div>
           <div className="flex justify-between items-center border-b pb-4">
