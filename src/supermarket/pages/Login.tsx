        ...
        <div className="w-full p-8">
           <div className="flex items-center gap-2 mb-8 justify-center">
              ...
              <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-white">
                <span className="text-[var(--color-accent-light)]">ORIENT</span> SUITE
              </h1>
           </div>
           ...
           <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                 ...
                 <input 
                   type="email" 
                   required
                   className="w-full rounded-lg border-gray-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:ring-[var(--color-accent-light)] focus:border-[var(--color-accent-light)]"
           ...
           <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
              Don't have an account? <button onClick={() => onNavigate('Register')} className="text-[var(--color-accent-light)] font-bold hover:underline">Create one</button>
           </div>
