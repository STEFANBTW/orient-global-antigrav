...
export default function Audio({ navigateTo, onProductClick, onAdd }: { navigateTo: (view: string) => void, onProductClick?: (product: any) => void, onAdd: (product: any) => void }) {
  return (
                    ...
                    <button
                      onClick={(e) => {
                        ...
                        onAdd({
                          ...
                          category: "Luxe",
                          context: "RETAIL",
                          image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBS2CxV_D0qntpuqBmoLaeVxh3vu1u1aM6pTqBd-gYV4w4fYm3o9yNuTPGKBljTpwkVFWfuUzIvDYhLjaSx5J4oaAOrmcaiqaOaW-gDdSUH6PUdLcZJ_jrKlp8M-WQ7_G1-ovN0NNl9v6TGFJf1w9ImUnwtqBvaEmlFM-gUZwc4rn6YfgPCxoTOKZuNPG0E1cDOJ2SAyVQxODFMfXgXDlD05TxUCxd_qzDBnuTt8qf8soZWBW6GpT5VUHJv6teUw9wfmPsq8YZrMXau"
                        });
                      }}
                      className="bg-primary hover:bg-orange-600 text-white p-3 rounded-lg transition-colors flex items-center justify-center"
                    >
                    ...
                    <button
                      onClick={(e) => {
                        ...
                        onAdd({
                          ...
                          category: "Luxe",
                          context: "RETAIL",
                          image: "https://lh3.googleusercontent.com/aida-public/AB6AXuC-NzZ17lq-y00WdAVajFZWkIxPY6gKwFlfykHTVnl0B5cZ7XedoiIUFTTIA-U3kCLiBd9sEPPPq9pDaGqJQjZl0v8BrHYuwRpev9ihufgryPFGSubnVzdlw6OXwe8SbYeFNfJlFlQ5AAMwU3tFlf5fCdeqf4U3IG1wIS6V1oFGbqcL5mqVeNAJ8oFzlCBoEjPgZhXirOb3lLdjHgOxBMk7YEGxyaosAkEml10SbDHkcND69PrQ_QX2ZAjTX1VevWxwcOLK1-NrFxZ0"
                        });
                      }}
                      className="bg-primary hover:bg-orange-600 text-white p-3 rounded-lg transition-colors flex items-center justify-center"
                    >
                    ...
                    <button
                      onClick={(e) => {
                        ...
                        onAdd({
                          ...
                          category: "Luxe",
                          context: "RETAIL",
                          image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAjsy2SwbJ60U8H2YRIP6_5yTUhACIBWbs5lxuPHCPAb4RSt6twD6eoMV2XIqiTgfDY7MyhCglHROfhZoOLT9Iezj1M7rjP0VrCTXt-u2_l0f_jt41QzPgZAzULBChlf6FqanxU9HDwrU5Fdg1w1bHFb1ne6zhBDzprxuhm1Xjd4L29yYwhYXuggX_k-nWQQTdLWdwzh-nVin4IQ_suQMuzDxqDu99LgFEvw9_v2UaNbZkF58DipOOmj5b1kgjt3FK7b9jNeVNEH4pk"
                        });
                      }}
                      className="bg-primary hover:bg-orange-600 text-white p-3 rounded-lg transition-colors flex items-center justify-center"
                    >
