...
export default function TVs({ navigateTo, onProductClick, onAdd }: { navigateTo: (view: string) => void, onProductClick?: (product: any) => void, onAdd: (product: any) => void }) {
  return (
          ...
          <div className="flex items-center justify-between h-16 gap-8">
            ...
            <div className="hidden md:flex flex-1 max-w-lg">
              <div className="relative w-full">
                ...
                <input className="block w-full pl-10 pr-3 py-2 border-none bg-primary/5 dark:bg-primary/10 rounded-lg focus:ring-2 focus:ring-primary text-sm" placeholder="Search TVs, soundbars, projectors..." type="text" />
              </div>
            </div>
            {/* Nav Actions */}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <nav aria-label="Breadcrumb" className="flex text-sm text-slate-500 dark:text-slate-400 mb-8">
          <ol className="flex items-center space-x-2">
            ...
            <li><span className="material-symbols-outlined text-xs">chevron_right</span></li>
            <li className="text-primary font-semibold">TVs &amp; Home Theater</li>
          </ol>
        </nav>
        <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center gap-2 cursor-pointer group">
                        ...
                        <span className="text-sm group-hover:text-primary">OLED TVs</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                        <span className="text-sm group-hover:text-primary">QLED TVs</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                        <span className="text-sm group-hover:text-primary">4K UHD TVs</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                        <span className="text-sm group-hover:text-primary">Soundbars</span>
                      </label>
                    </div>
                  </div>
                  {/* Screen Size */}
                  <div>
                    <h4 className="text-sm font-semibold mb-3">Screen Size</h4>
                    <div className="space-y-2">
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                        <span className="text-sm group-hover:text-primary">Up to 43"</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                        <span className="text-sm group-hover:text-primary">50" - 55"</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                        <span className="text-sm group-hover:text-primary">65" - 75"</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                        <span className="text-sm group-hover:text-primary">85" &amp; Above</span>
                      </label>
                    </div>
                  </div>
                  {/* Brands */}
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                        <span className="text-sm group-hover:text-primary">LG</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                      ...
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                        <span className="text-sm group-hover:text-primary">TCL</span>
                      </label>
                      <label className="flex items-center gap-2 cursor-pointer group">
                        <input className="rounded border-slate-300 text-primary focus:ring-primary" type="checkbox" />
                        <span className="text-sm group-hover:text-primary">Hisense</span>
                      </label>
                    </div>
                  </div>
                  {/* Price Range */}
          ...
          <div className="flex-1">
            {/* Category Header */}
            <div className="mb-10 p-10 rounded-2xl bg-gradient-to-br from-blue-900 to-indigo-900 text-white relative overflow-hidden">
              <div className="relative z-10 max-w-lg">
                <h1 className="text-5xl font-black mb-4 tracking-tighter">Cinematic Experience</h1>
                <p className="text-indigo-100/90 text-lg leading-relaxed">Transform your living room into a theater. Discover stunning 4K and 8K TVs with immersive sound.</p>
                <div className="mt-6 flex gap-3">
                  <span className="bg-white/10 backdrop-blur-md px-4 py-1.5 rounded-full text-sm font-medium border border-white/20">OLED</span>
                  <span className="bg-white/10 backdrop-blur-md px-4 py-1.5 rounded-full text-sm font-medium border border-white/20">Mini-LED</span>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between mb-8 border-b border-primary/10 pb-4">
              <p className="text-sm font-medium"><span className="text-primary font-bold">184</span> Products found</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
              ...
              <div className="group bg-white dark:bg-background-dark/50 rounded-xl overflow-hidden border border-transparent hover:border-primary/20 hover:shadow-2xl transition-all duration-300">
                <div className="aspect-square bg-slate-100 dark:bg-slate-800 relative overflow-hidden">
                  <img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" data-alt="LG C3 OLED TV" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBKW1VrCA_Qausfryr-ixn8tpSMTQMNKwfcrSPuZHFp_EdW52oyaJAief_qFIzuZA_egHu0kMs0qHO2zBD8Slx_JuLthlm_aL-7T1zBMg3i3C5sC_oks21BEG91DNWM17OK5wgpGMhFc6DX91f5bMaVyEUFblfXk__6vcebSstd8BvbJses6w3VhKtIEGaQg2GpdiC0QtRE4A6J5R1ZXQEo1Uy-MyNLcgMaBRaWvLD_wXuDGDydAqQjGZkVMWpc7wadMflIew6loKAQ" referrerPolicy="no-referrer" />
                  ...
                  <span className="absolute bottom-4 left-4 bg-primary text-white text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider">Top Rated</span>
                </div>
                <div className="p-6">
                  ...
                  <h3 className="font-bold text-lg mb-1 group-hover:text-primary transition-colors">LG 65" Class C3 Series OLED 4K UHD Smart webOS TV</h3>
                  <p className="text-sm text-slate-500 line-clamp-2 mb-4">Experience perfect black and infinite contrast with the LG OLED C3.</p>
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-black text-slate-900 dark:text-white">$1,699.99</span>
              ...
              <div className="group bg-white dark:bg-background-dark/50 rounded-xl overflow-hidden border border-transparent hover:border-primary/20 hover:shadow-2xl transition-all duration-300">
                <div className="aspect-square bg-slate-100 dark:bg-slate-800 relative overflow-hidden">
                  <img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" data-alt="Samsung QLED TV" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBKW1VrCA_Qausfryr-ixn8tpSMTQMNKwfcrSPuZHFp_EdW52oyaJAief_qFIzuZA_egHu0kMs0qHO2zBD8Slx_JuLthlm_aL-7T1zBMg3i3C5sC_oks21BEG91DNWM17OK5wgpGMhFc6DX91f5bMaVyEUFblfXk__6vcebSstd8BvbJses6w3VhKtIEGaQg2GpdiC0QtRE4A6J5R1ZXQEo1Uy-MyNLcgMaBRaWvLD_wXuDGDydAqQjGZkVMWpc7wadMflIew6loKAQ" referrerPolicy="no-referrer" />
                  <button className="absolute top-4 right-4 size-10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-full flex items-center justify-center text-slate-400 hover:text-red-500 transition-colors">
                    <span className="material-symbols-outlined">favorite</span>
                  </button>
                </div>
                <div className="p-6">
                  <div className="flex items-center gap-1 text-yellow-500 mb-2">
                    ...
                    <span className="material-symbols-outlined text-sm">star</span>
                    <span className="material-symbols-outlined text-sm">star</span>
                    <span className="text-xs text-slate-400 ml-1">(890)</span>
                  </div>
                  <h3 className="font-bold text-lg mb-1 group-hover:text-primary transition-colors">Samsung 75" Class QN90C Neo QLED 4K Smart TV</h3>
                  <p className="text-sm text-slate-500 line-clamp-2 mb-4">Brilliant details shine even in daylight with Quantum Matrix Technology.</p>
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-black text-slate-900 dark:text-white">$2,199.99</span>
                    <button className="bg-primary hover:bg-orange-600 text-white p-3 rounded-lg transition-colors flex items-center justify-center">
                      <span className="material-symbols-outlined">add_shopping_cart</span>
                    </button>
                  </div>
              ...
              <div className="group bg-white dark:bg-background-dark/50 rounded-xl overflow-hidden border border-transparent hover:border-primary/20 hover:shadow-2xl transition-all duration-300">
                <div className="aspect-square bg-slate-100 dark:bg-slate-800 relative overflow-hidden">
                  <img className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" data-alt="Sony Bravia XR TV" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBKW1VrCA_Qausfryr-ixn8tpSMTQMNKwfcrSPuZHFp_EdW52oyaJAief_qFIzuZA_egHu0kMs0qHO2zBD8Slx_JuLthlm_aL-7T1zBMg3i3C5sC_oks21BEG91DNWM17OK5wgpGMhFc6DX91f5bMaVyEUFblfXk__6vcebSstd8BvbJses6w3VhKtIEGaQg2GpdiC0QtRE4A6J5R1ZXQEo1Uy-MyNLcgMaBRaWvLD_wXuDGDydAqQjGZkVMWpc7wadMflIew6loKAQ" referrerPolicy="no-referrer" />
                  <button className="absolute top-4 right-4 size-10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-full flex items-center justify-center text-slate-400 hover:text-red-500 transition-colors">
                    <span className="material-symbols-outlined">favorite</span>
                  </button>
                ...
                <div className="p-6">
                  <div className="flex items-center gap-1 text-yellow-500 mb-2">
                    ...
                    <span className="material-symbols-outlined text-sm">star</span>
                    <span className="material-symbols-outlined text-sm">star_half</span>
                    <span className="text-xs text-slate-400 ml-1">(650)</span>
                  </div>
                  <h3 className="font-bold text-lg mb-1 group-hover:text-primary transition-colors">Sony 65" Class BRAVIA XR A80L OLED 4K HDR Smart TV</h3>
                  <p className="text-sm text-slate-500 line-clamp-2 mb-4">Intelligent TV processing technology powered by Cognitive Processor XR.</p>
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-black text-slate-900 dark:text-white">$1,899.99</span>
                    <button className="bg-primary hover:bg-orange-600 text-white p-3 rounded-lg transition-colors flex items-center justify-center">
                      <span className="material-symbols-outlined">add_shopping_cart</span>
                    </button>
                  </div>
            ...
            <div className="my-20 p-12 rounded-3xl bg-slate-900 text-white flex flex-col md:flex-row items-center gap-10">
              <div className="w-full md:w-1/2">
                <img className="rounded-2xl shadow-2xl" data-alt="Home theater setup with soundbar" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBKW1VrCA_Qausfryr-ixn8tpSMTQMNKwfcrSPuZHFp_EdW52oyaJAief_qFIzuZA_egHu0kMs0qHO2zBD8Slx_JuLthlm_aL-7T1zBMg3i3C5sC_oks21BEG91DNWM17OK5wgpGMhFc6DX91f5bMaVyEUFblfXk__6vcebSstd8BvbJses6w3VhKtIEGaQg2GpdiC0QtRE4A6J5R1ZXQEo1Uy-MyNLcgMaBRaWvLD_wXuDGDydAqQjGZkVMWpc7wadMflIew6loKAQ" referrerPolicy="no-referrer" />
              </div>
              <div className="w-full md:w-1/2 space-y-6">
                <h2 className="text-4xl font-black leading-tight italic">"Complete the experience."</h2>
                <p className="text-slate-400 text-lg">Pair your new TV with a premium soundbar for immersive Dolby Atmos audio.</p>
                <button className="bg-white text-slate-900 px-8 py-3 rounded-full font-bold hover:bg-primary hover:text-white transition-all">Shop Soundbars</button>
              </div>
            </div>
            {/* Pagination */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <p className="text-sm mb-4">Get the latest updates on TV tech and releases.</p>
